...
| 投機的トークン | Speculative Token | 取引所で売買され価格変動が大きいトークン。CU とは設計思想が異なる | [第11章](11-competitive-landscape.md) |
...
| iroh | iroh | Forge が採用する QUIC ベースの P2P トランスポート | [第12章](12-p2p-architecture.md) |
...
| 抜き打ち再計算 | Random Re-computation | 一部の CU 計算を第三者が再検証して整合性を担保する手法 | [第13章](13-open-questions.md) |
...
| ハイブリッド L2 | Hybrid L2 | Forge が提案する 3 層構造（BTC L0 / CU L1 / Stablecoin L2） | [第14章](14-programmable-money.md) |
